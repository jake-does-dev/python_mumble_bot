// General MIDI program (instrument) names, indexed by program number 0-127.
// The backend returns instrument "lines" as program numbers; the UI labels them
// with these names. Mirrors pmb_core.audio.midi.GM_INSTRUMENTS.
...
export function gmInstrumentName(program) {
